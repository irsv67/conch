var TemplateBusiness = /** @class */ (function () {
    function TemplateBusiness() {
    }
    TemplateBusiness.prototype.getHtmlStr = function (pageName, pageNameUpper) {
        var str_b = '';
        str_b += "<!--include_start-->\r\n";
    ...
    TemplateBusiness.prototype.getCompStr = function (pageName, pageNameUpper) {
        var str_b = '';
    ...
    TemplateBusiness.prototype.getStyleStr = function (pageName, pageNameUpper) {
        var str_b = '';
        str_b += "/*====include_start====*/\r\n";
        str_b += "/*====include_end====*/\r\n";
        return str_b;
    };
    TemplateBusiness.prototype.getModuleStr = function (pageName, pageNameUpper) {
        var str_b = '';
    ...
    TemplateBusiness.prototype.getServiceStr = function (pageName, pageNameUpper) {
        var str_b = '';
    ...
    TemplateBusiness.prototype.getRoutingStr = function (pageName, pageNameUpper) {
        var str_b = '';
        str_b += "import {NgModule} from '@angular/core';\r\n";
    ...
    TemplateBusiness.prototype.getRouterStr = function (folderPath, pageName, pageNameUpper) {
        var str_b = '';
        str_b += "    {\r\n";
        str_b += "        path: '" + pageName + "',\r\n";
    ...
    TemplateBusiness.prototype.getMenuStr = function (folderPath, pageName, menuName) {
        var str_b = '';
        str_b += "        {\r\n";
        str_b += "            name: '" + pageName + "',\r\n";
        str_b += "            desc: '" + menuName + "',\r\n";
